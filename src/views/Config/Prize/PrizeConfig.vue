...
<template>
    <div>
        ...
        <div class="flex w-full gap-3">
            <button class="btn btn-info btn-sm" @click="addPrize">Thêm</button>
            <button class="btn btn-info btn-sm" @click="resetDefault">Danh sách mặc định</button>
            <button class="btn btn-error btn-sm" @click="delAll">Xóa tất cả</button>
        ...
        <div role="alert" class="w-full my-4 alert alert-info">
            ...
            <span>Việc thực hiện thao tác có thể làm reset dữ liệu, xin hãy cẩn thận khi thao tác</span>
        </div>
        <ul class="p-0 m-0">
