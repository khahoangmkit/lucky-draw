    ...
    <div class="absolute z-10 flex flex-col items-center justify-center -translate-x-1/2 left-1/2">
        ...
        <div class="flex gap-3">
            <button v-if="tableData.length <= 0" class="cursor-pointer btn btn-outline btn-secondary btn-lg"
                @click="router.push('config')">Nhập dữ liệu</button>
            <button v-if="tableData.length <= 0" class="cursor-pointer btn btn-outline btn-secondary btn-lg"
                @click="setDefaultPersonList">Sử dụng dữ liệu mẫu</button>
        </div>
    </div>
    <div id="container" ref="containerRef" class="3dContainer">
        ...
        <div id="menu">
            <button class="btn-end " @click="enterLottery"
                v-if="currentStatus == 0 && tableData.length > 0">Trộn thẻ</button>

            <div class="start" v-if="currentStatus == 1">
                <button class="btn-start" @click="startLottery"><strong>Bắt đầu quay</strong>
            ...
            <div v-if="currentStatus == 3" class="flex justify-center gap-6 enStop">
                <div class="start">
                    <button class="btn-start" @click="continueLottery"><strong>Quay tiếp！</strong>
                        <div id="container-stars">
                            <div id="stars"></div>
                        </div>
