        ...
        <dialog id="my_modal_1" ref="temporaryPrizeRef" class="border-none modal">
            <div class="modal-box">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <label class="flex w-full max-w-xs">
                        <div class="label">
                            <span class="label-text">Tất cả mọi người tham gia</span>
                        </div>
                    ...
                    <label class="flex w-full max-w-xs">
                        <div class="label">
                            <span class="label-text">Số phần thưởng</span>
                        </div>
                        <input type="number" v-model="temporaryPrize.count" @change="changePersonCount" placeholder="Số phần thưởng"
                            class="max-w-xs input-sm input input-bordered" />
                    </label>
                    <label class="flex w-full max-w-xs">
                        <div class="label">
                            <span class="label-text">Số người đã trúng thưởng</span>
                        </div>
                        <input disabled type="number" v-model="temporaryPrize.isUsedCount" placeholder="người đã trúng thưởng"
                            class="max-w-xs input-sm input input-bordered" />
                    </label>
                    <label class="flex w-full max-w-xs" v-if="temporaryPrize.separateCount">
                    <div class="label">
                        <span class="label-text">Số lượng phần thưởng mỗi lần</span>
                    </div>
                    <div class="flex justify-start h-full" @click="selectPrize(temporaryPrize)">
                        ...
                        <button v-else class="btn btn-secondary btn-xs">Cài đặt</button>
                    </div>
                </label>
                    <label class="flex w-full max-w-xs">
                        <div class="label">
                ...
                <div class="modal-action">
                    <form method="dialog" class="flex gap-3">
                        <button class="btn btn-sm" @click="submitTemporaryPrize">Xác nhận</button>
                        <button class="btn btn-sm">Hủy</button>
                    </form>
                </div>
            </div>
        </dialog>
